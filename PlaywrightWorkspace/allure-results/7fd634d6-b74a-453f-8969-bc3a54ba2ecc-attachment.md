...
Locator: getByRole('link', { name: 'Terms and Conditions' })
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Terms and Conditions' })
...
```ts
  ...
  35 | 
  36 | 
  37 |     //To verify "Terms & Conditions link url"
  38 |     const termsLink = page.getByRole('link', { name: 'Terms and Conditions' });
  39 |     
  40 |     //await expect(termsLink).toBeVisible();
> 41 |     await expect(termsLink).toHaveAttribute(
     |                             ^ Error: expect(locator).toHaveAttribute(expected) failed
  42 |        'href',
  43 |        'https://www.verizon.com/support/my-verizon-terms/'
  44 |        );
  45 | }
  46 | );
  47 | 
