...
> 93  |     await expect(await page.locator('First')).toBeDisabled();
  ...
  102 | 
  103 | 
  104 | //Add 10 records to the table and verify next , last should be enabled
  105 | //click next or last buttons 
  106 | //verify First and Previous buttons should be enabled
  107 | //Verify next and last buttons are disbaled
```