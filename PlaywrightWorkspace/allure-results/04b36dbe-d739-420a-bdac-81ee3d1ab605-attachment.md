...
Expected: "https://secure.verizon.com//support/my-verizon-terms/"
...
> 61 |         await expect(page).toHaveURL('https://secure.verizon.com//support/my-verizon-terms/');// cannot use termsTextlocator as it is a locator having text
     |                            ^ Error: expect(page).toHaveURL(expected) failed
  62 |         await page.waitForTimeout(2000);
  63 |         console.log(page.url());
  64 |         
  65 |         
  66 |          
  67 | }
