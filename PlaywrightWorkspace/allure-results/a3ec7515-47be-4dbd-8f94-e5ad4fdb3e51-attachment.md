...
```
Error: locator.check: Error: strict mode violation: locator('iframe') resolved to 5 elements:
    1) <iframe title="runner" aria-live="polite" sandbox="allow-scripts allow-same-origin allow-forms allow-modals allow-top-navigation-by-user-activation" src="https://514786ee-de2b-48c0-8299-19a5539e19f3.mdnplay.dev/runner.html?uuid=514786ee-de2b-48c0-8299-19a5539e19f3&state=pZHBTsMwDIZfxfK5oyBxKl1PaOLAbddc3MZdA4k7JelgmvbuKE0HHAZC4mRFn%2F37s3LCITqLFda9YasDx0YJQG15x6KbLVvuIhA4MhJZSDoG7Ufhqi6XHiXzhDaHeRSgNrKfIsTjntcKPWkzKgSj1wqHiY8KQcglNAcphAPZib9oN3D3yhrKS56lli30o%2F%2FsaZ4mPtblDLJwmff%2FXUXz228uF3xVYoHNY6r…></iframe> aka getByRole('region', { name: 'Try it' }).locator('iframe[title="runner"]')
    2) <iframe title="runner" aria-live="polite" sandbox="allow-scripts allow-same-origin allow-forms allow-modals allow-downloads allow-fullscreen allow-orientation-lock" src="https://7ad458dfa6397d4c0abe6ebc660d885a512b2336.mdnplay.dev/en-US/docs/Web/HTML/Reference/Elements/input/radio/runner.html?uuid=7ad458dfa6397d4c0abe6ebc660d885a512b2336&state=nZJNa8MwDIb%2FitC5YNbeguvL2HFQ2NUXJ1ZqD38EWymUsf8%2Bknl0ZaOsO%2BnDr18eJL2h4xiwQznmEpVOAHL0FGwlXisAGehIyapDIFMJKgUaGM55LjAVGqkUsjDkxGZgiMQu206K9qlZWH9qKYD0aZoZ%2…></iframe> aka getByRole('region', { name: 'Defining a radio group' }).locator('iframe[title="runner"]')
    3) <iframe title="runner" aria-live="polite" sandbox="allow-scripts allow-same-origin allow-forms allow-modals allow-downloads allow-fullscreen allow-orientation-lock" src="https://f66c18cba0431b43d3a22dd71c3b5f98dd40289d.mdnplay.dev/en-US/docs/Web/HTML/Reference/Elements/input/radio/runner.html?uuid=f66c18cba0431b43d3a22dd71c3b5f98dd40289d&state=nVLBbtswDP0VguvBAYJ4bW%2BZ7MvanTagQHebClSxaFuDLHkynS0I%2FO%2BDZAfp0CFYd7Fo8r3HR1FHbLmzuEVR%2B9CV0gGI2pDVA3H6AxCWGnK6fLCkBoKBLFUMBz8G6APVFAJpqLxjVTF0xK3XW5EvpEVC…></iframe> aka getByRole('region', { name: 'Data representation of a' }).locator('iframe[title="runner"]')
    4) <iframe title="runner" aria-live="polite" sandbox="allow-scripts allow-same-origin allow-forms allow-modals allow-downloads allow-fullscreen allow-orientation-lock" src="https://cf97a6c6769b21f8cd465f6533b41f4207804222.mdnplay.dev/en-US/docs/Web/HTML/Reference/Elements/input/radio/runner.html?uuid=cf97a6c6769b21f8cd465f6533b41f4207804222&state=nZJNa8MwDIb%2FitC5YNbeguvL2HFQ2NUXx1Zqb%2F4IjlMoY%2F99JE2XZC2j7GTJr%2Fz6saVPtCV4rJA3KQchIwBvHHnTURkzAO7pSNGIgyfVEXTkSRc4pz5Dm6mhnMmATrEoXSBQsclUnE2HJgvjTlMIwF1s…></iframe> aka getByRole('region', { name: 'Selecting a radio button by' }).locator('iframe[title="runner"]')
    5) <iframe title="runner" aria-live="polite" sandbox="allow-scripts allow-same-origin allow-forms allow-modals allow-downloads allow-fullscreen allow-orientation-lock" src="https://11b08641a29ed3ffae222e57327c338a3b5ff449.mdnplay.dev/en-US/docs/Web/HTML/Reference/Elements/input/radio/runner.html?uuid=11b08641a29ed3ffae222e57327c338a3b5ff449&state=nVTBjpswEP2VkaveQkmy3ZXqsFyqHiut1CsXYw9husZGtsluGu2%2FV2AIJFlVq3LCM%2FOe37wZOLE6NJpxllXWNXlhALKKUCuPYTgBZBr3aFT%2BpFF4BI8aZYCj7Ry0Dit0DhVIa4KQARoMtVU8S0fQSKHoML…></iframe> aka getByRole('region', { name: 'Styling radio inputs' }).locator('iframe[title="runner"]')

Call log:
  - waiting for locator('iframe').contentFrame().getByLabel('Huey')
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e7]:
    - generic [ref=e8]:
      - link "Twilio Connect communication channels, contextual data, and integrated AI-driven workflows all in one place. Learn more" [ref=e9] [cursor=pointer]:
        - /url: /pong/click?code=aHR0cHM6Ly9zcnYuYnV5c2VsbGFkcy5jb20vYWRzL2NsaWNrL3gvR1RORDQyN1lDRUFENEtKTEZUNzRZS1FVRlRCSVYyM01DWUJJVFozSkNBQURQS0pVQ1RCSVA1UUtDSzdJVEszWUNWWURMS1FZQ0VCSTVLUVlDS0JENEszS0M2U0lFMjNZQ1k3RFRLM0VISk5DTFNJWg%3D%3D.1ES1nrCjYqWUn2YW3o6vMjPo8hxqYo6oRez2Gq5B0k0%3D&version=2
        - generic [ref=e10]:
          - img "Twilio" [ref=e11]
          - generic [ref=e12]: Connect communication channels, contextual data, and integrated AI-driven workflows all in one place.
  ...
  - generic [ref=e101]:
    - main [ref=e102]:
      ...
      - complementary [ref=e127]:
        ...
        - generic [ref=e152]:
          - generic [ref=e153]:
            - link "Twilio The platform that makes more possible It's never been easier to build amazing engagement. Learn More" [ref=e154] [cursor=pointer]:
              - /url: /pong/click?code=aHR0cHM6Ly9zcnYuYnV5c2VsbGFkcy5jb20vYWRzL2NsaWNrL3gvR1RORDQyN1lDRUFENEtKTEZUWUxZS1FVRlRCSVYyM01DWUJJNFozSkNBQURQS0pVQ1RCSUNLUUtDNkJJQzI3WUY2WUlUMlE3Q1RCRDQyUTdDNjdJUDI3N0hFWUk1NTNXRlRTRDZLM0VDVE5DWUJaNTJL.mp61eW6mNWC3x1ldxuTLeqVv7YYJc78VoYWeiFxdkwk%3D&version=2
              - img "Twilio" [ref=e155]
              - generic [ref=e156]:
                - strong [ref=e157]: The platform that makes more possible
                - generic [ref=e158]: It's never been easier to build amazing engagement.
  ...
  - generic [ref=e1157]:
    - generic [ref=e1160]:
      - link "WorkOS Homepage Bottom Banner" [ref=e1161] [cursor=pointer]:
        - /url: /pong/click?code=aHR0cHM6Ly9zcnYuYnV5c2VsbGFkcy5jb20vYWRzL2NsaWNrL3gvR1RORDQyN1lDRUFENDIzN0NUQUxZS1FVRlRCSVZLSjdDS0FENlozSkNBQURQS0pVQ1RCRDQyUUtDNlNJNjUzRUNUQklDMkpXQ0VBRDQyUUxGNkJJUDJRSUhFWUk1NTNXRlRTRDZLM0VDVE5DWUJaNTJL.3z%2FhgDzUmVoKdkaR%2FmTzZr3%2B9TcOPpa1g9MpJhzn3Nk%3D&version=2
...
```ts
  ...
  7  |   const demoFrame = page.frameLocator('iframe');
  8  | 
